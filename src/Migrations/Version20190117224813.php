 ...
 */
final class Version20190117224813 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE products CHANGE deleted_at deleted_at DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE order_ateliersweets (id INT AUTO_INCREMENT NOT NULL, ateliersweet_id INT NOT NULL, order_id INT NOT NULL, INDEX IDX_A9A5E0988D9F6D38 (order_id), UNIQUE INDEX uniq_orderateliersweet (order_id, ateliersweet_id), INDEX IDX_A9A5E0985CF55047 (ateliersweet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE products CHANGE deleted_at deleted_at DATETIME NOT NULL');
    }
}
